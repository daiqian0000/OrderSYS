 ...
 * 
 */
public interface ObjectStorageService extends FileStorage {
	 ...
	 * 分块大小
	 */
	String PART_SIZE = "partSize";
	
	/**
	 * 并发线程数量
	 */
	String TASK_NUM = "taskNum";
	
	/**
	 * 时长
	 */
	String TIME_LENGTH = "timeLength";
	 ...
	 * @return 追加对象结果
	 */
	AppendObjectResult appendObject(String bucket, String key, File file,
	 ...
	 * @return 追加对象结果
	 */
	AppendObjectResult appendObject(String bucket, String key,
			InputStream input, AppendObjectResult appendObjectResult);
	 ...
	 *            权限
	 */
	void setObjectAcl(String bucket, String key,
	 ...
	 * @return 文件拷贝结果
	 */
	CopyObjectResult copyObject(String srcBucket, String srcKey,
	 ...
	 * @return 文件分块上传结果
	 */
	CompleteMultipartUploadResult multipartUpload(String bucket,
	 ...
	 *            输出流
	 */
	void getObjectContent(String bucket, String key,
	 ...
	 *            输出流
	 */
	void getObjectContent(String key, OutputStream outputStream);
