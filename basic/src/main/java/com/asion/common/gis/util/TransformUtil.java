...
public abstract class TransformUtil {
	 ...
	 * 米制范围
	 */
	public static final double METER_LIMIT = 20037508.3427892;
	 ...
	 * @return WEB墨卡托坐标
	 */
	public static double[] wgs84ToMercator(double x, double y) {
	...
	public static double[] mercatorToWgs84(double x, double y) {
		...
		ty = 180 / Math.PI * (2 * Math.atan(Math.exp(y * Math.PI / 180)) - Math.PI / 2);
		coordinate[0] = tx;
		coordinate[1] = ty;
		return coordinate;
	}
	 ...
	 * @return 坐标
	 */
	public static double[] wgs84ToGcj02(double x, double y) {
	 ...
	 * @return 坐标
	 */
	public static double[] gcj02ToBd09(double x, double y) {
	 ...
	 * @return 坐标
	 */
	public static double[] bd09ToGcj02(double x, double y) {
		double bx = x - 0.0065;
		double by = y - 0.006;
	 ...
	 * @return 坐标
	 */
	public static double[] bd09ToWgs84(double x, double y) {
